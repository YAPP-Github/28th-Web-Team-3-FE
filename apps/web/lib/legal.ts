 ...
 *
 * 개인정보 보호책임자 표기도 이 값을 쓴다. 개인정보 보호법 제30조 제1항 제6호는 처리방침에
 * 보호책임자의 "성명" 또는 "고충사항을 처리하는 부서의 명칭" 중 하나를 싣도록 하므로 팀 명칭으로
 * 갈음한다.
 */
export const OPERATOR_NAME = "아끼모 운영팀";

/**
 * 개인정보 관련 문의 창구. 위 조문이 부서 명칭과 함께 "전화번호 등 연락처"를 요구하는데
