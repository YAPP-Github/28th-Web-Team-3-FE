  ...
  return (
    <div className="fixed inset-x-0 bottom-24 z-10 mx-auto flex w-full max-w-md flex-col items-end gap-3 px-5">
      ...
      <button
        ...
        className="flex size-[52px] items-center justify-center rounded-full bg-blue-500 text-gray-0 shadow-[0_2px_12px_rgba(35,37,41,0.15)] hover:bg-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-300"
        type="button"
        onClick={onToggle}
      >
