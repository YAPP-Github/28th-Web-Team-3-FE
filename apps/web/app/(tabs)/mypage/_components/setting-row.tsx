 ...
 */
const ROW_CLASS =
  "-mx-5 block px-5 transition-colors duration-100 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset active:bg-gray-50 motion-reduce:transition-none";
