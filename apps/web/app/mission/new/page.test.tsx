...
describe("NewMissionPage", () => {
  it("카테고리를 하나만 선택해 폼으로 이동한다", () => {
    ...
    expect(screen.getByRole("button", { name: "식비" })).toHaveAttribute("data-state", "off");
    ...
    expect(pushMock).toHaveBeenCalledWith("/mission/new/form?category=%EC%B7%A8%EB%AF%B8");
  });
});
